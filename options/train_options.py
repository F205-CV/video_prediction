...
class TrainOptions(BaseOptions):
    def initialize(self):
 	...
 	self.parser.add_argument('--d_step', type=int, default=10, help='# of train discriminator')
 	self.parser.add_argument('--p_step', type=int, default=10, help='# of train predictor')
        self.parser.add_argument('--beta1', type=float, default=0.5, help='momentum term of adam')
        self.parser.add_argument('--lr', type=float, default=0.0002, help='initial learning rate for adam')
        self.parser.add_argument('--no_lsgan', action='store_true', help='do *not* use least square GAN, if false, use vanilla GAN')
        self.parser.add_argument('--lambda_fea', type=float, default=10.0, help='weight for feature loss ')
        self.parser.add_argument('--lambda_pix', type=float, default=10.0, help='weight for pixel loss ')
        self.parser.add_argument('--lambda_gan', type=float, default=1, help='')
