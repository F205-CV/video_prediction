...
class BaseOptions():
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--latent_nc', type=int, default=16, help='# of encode feature channels')
        self.parser.add_argument('--output_nc', type=int, default=3, help='# of output image channels')
        self.parser.add_argument('--seq_len', type=int, default=4, help='sequence length of input')
        self.parser.add_argument('--pre_len', type=int, default=1, help='sequence length of prediction')
        ...
        self.parser.add_argument('--which_model_E', type=str, default='resnet_3blocks', help='selects model to use for netG')
        ...
        self.parser.add_argument('--model', type=str, default='seperate_train',
